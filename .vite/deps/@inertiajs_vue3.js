...
function k(t, e, i, n = "brackets") {
  let o = /^https?:\/\//.test(e.toString()), c2 = o || e.toString().startsWith("/"), h2 = !c2 && !e.toString().startsWith("#") && !e.toString().startsWith("?"), m = e.toString().includes("?") || t === "get" && Object.keys(i).length, b2 = e.toString().includes("#"), a = new URL(e.toString(), "http://localhost");
  return t === "get" && Object.keys(i).length && (a.search = O.stringify((0, import_deepmerge.default)(O.parse(a.search, { ignoreQueryPrefix: true }), i), { encodeValuesOnly: true, arrayFormat: n }), i = {}), [[o ? `${a.protocol}//${a.host}` : "", c2 ? a.pathname : "", h2 ? a.pathname.substring(1) : "", m ? a.search : "", b2 ? a.hash : ""].join(""), i];
}
function w(t) {
...
var C = class {
  ...
  visit(e, { method: i = "get", data: n = {}, replace: o = false, preserveScroll: c2 = false, preserveState: h2 = false, only: m = [], headers: b2 = {}, errorBag: a = "", forceFormData: l = false, onCancelToken: g = () => {
  }, onBefore: L2 = () => {
  }, onStart: d = () => {
  }, onProgress: p = () => {
  }, onFinish: T2 = () => {
    ...
    let P = { url: x, method: i, data: n, replace: o, preserveScroll: c2, preserveState: h2, only: m, headers: b2, errorBag: a, forceFormData: l, queryStringArrayFormat: F, cancelled: false, completed: false, interrupted: false };
    if (L2(P) === false || !M(P))
      return;
    this.activeVisit && this.cancelVisit(this.activeVisit, { interrupted: true }), this.saveScrollPositions();
    let G2 = this.createVisitId();
    this.activeVisit = { ...P, onCancelToken: g, onBefore: L2, onStart: d, onProgress: p, onFinish: T2, onCancel: y2, onSuccess: D, onError: U, queryStringArrayFormat: F, cancelToken: new AbortController() }, g({ cancel: () => {
      this.activeVisit && this.cancelVisit(this.activeVisit, { cancelled: true });
      ...
      let E2 = x, V = v(s.url);
      return E2.hash && !V.hash && w(E2).href === V.href && (V.hash = E2.hash, s.url = V.href), this.setPage(s, { visitId: G2, replace: o, preserveScroll: c2, preserveState: h2 });
    }).then(() => {
...
function Q(t, e, i) {
  ...
  function b2() {
    let l = e(""), g = { ...l ? { title: `<title inertia="">${l}</title>` } : {} }, L2 = Object.values(n).reduce((d, p) => d.concat(p), []).reduce((d, p) => {
      ...
      return T2 ? d[T2[0]] = p : d[Object.keys(d).length] = p, d;
    }, g);
  ...
  return a(), { forceUpdate: a, createProvider: function() {
    let l = c2();
    return { update: (g) => m(l, g), disconnect: () => h2(l) };
  } };
}
var Y = null;
function ne(t) {
...
function v2(e, o) {
  let n = typeof e == "string" ? e : null, l = typeof e == "object" ? e : o, t = n ? Oe.restore(n) : null, p = (0, import_lodash2.default)(l), a = null, m = null, d = (r) => r, h2 = reactive({ ...t ? t.data : l, isDirty: false, errors: t ? t.errors : {}, hasErrors: false, processing: false, progress: null, wasSuccessful: false, recentlySuccessful: false, data() {
    ...
    return r.length === 0 ? Object.assign(this, i) : Object.assign(this, Object.keys(i).filter((s) => r.includes(s)).reduce((s, f2) => (s[f2] = i[f2], s), {})), this;
  }, setError(r, i) {
    ...
    let f2 = d(this.data()), g = { ...s, onCancelToken: (u2) => {
      if (a = u2, s.onCancelToken)
        return s.onCancelToken(u2);
    }, onBefore: (u2) => {
      if (this.wasSuccessful = false, this.recentlySuccessful = false, clearTimeout(m), s.onBefore)
        return s.onBefore(u2);
    }, onStart: (u2) => {
      if (this.processing = true, s.onStart)
        return s.onStart(u2);
    }, onProgress: (u2) => {
      if (this.progress = u2, s.onProgress)
        return s.onProgress(u2);
    }, onSuccess: async (u2) => {
      ...
      let D = s.onSuccess ? await s.onSuccess(u2) : null;
      return p = (0, import_lodash2.default)(this.data()), this.isDirty = false, D;
    }, onError: (u2) => {
      if (this.processing = false, this.progress = null, this.clearErrors().setError(u2), s.onError)
        return s.onError(u2);
    }, onCancel: () => {
      ...
      if (this.processing = false, this.progress = null, a = null, s.onFinish)
        return s.onFinish(u2);
    } };
    r === "delete" ? Oe.delete(i, { ...g, data: f2 }) : Oe[r](i, f2, g);
  }, get(r, i) {
    this.submit("get", r, i);
  }, post(r, i) {
...
var N2 = defineComponent({ name: "Inertia", props: { initialPage: { type: Object, required: true }, initialComponent: { type: Object, required: false }, resolveComponent: { type: Function, required: false }, titleCallback: { type: Function, required: false, default: (e) => e }, onHeadUpdate: { type: Function, required: false, default: () => () => {
  ...
  return k2 = Q(p, l, t), p || (Oe.init({ initialPage: e, resolveComponent: n, swapComponent: async (a) => {
    ...
    if (c.value) {
      ...
      return C2.value && (c.value.layout = C2.value, C2.value = null), c.value.layout ? typeof c.value.layout == "function" ? c.value.layout(h, a) : (Array.isArray(c.value.layout) ? c.value.layout : [c.value.layout]).concat(a).reverse().reduce((m, d) => (d.inheritAttrs = !!d.inheritAttrs, h(d, { ...b.value.props }, () => m))) : a;
    }
  };
} });
var w2 = N2;
var $2 = { install(e) {
  Oe.form = v2, Object.defineProperty(e.config.globalProperties, "$inertia", { get: () => Oe }), Object.defineProperty(e.config.globalProperties, "$page", { get: () => b.value }), Object.defineProperty(e.config.globalProperties, "$headManager", { get: () => k2 }), e.mixin(_2);
} };
function J2() {
  return b.value;
}
async function E({ id: e = "app", resolve: o, setup: n, title: l, progress: t = {}, page: p, render: a }) {
  let m = typeof window > "u", d = m ? null : document.getElementById(e), h2 = p || JSON.parse(d.dataset.page), r = (f2) => Promise.resolve(o(f2)).then((g) => g.default || g), i = [], s = await r(h2.component).then((f2) => n({ el: d, App: w2, props: { initialPage: h2, initialComponent: f2, resolveComponent: r, titleCallback: l, onHeadUpdate: m ? (g) => i = g : null }, plugin: $2 }));
  if (!m && t && Z(t), m) {
    let f2 = await a(createSSRApp({ render: () => h("div", { id: e, "data-page": JSON.stringify(h2), innerHTML: s ? a(s) : "" }) }));
    return { head: i, body: f2 };
  }
}
